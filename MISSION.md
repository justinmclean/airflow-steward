...
- Wire **Agentic Triage**, **Agentic Mentoring**, and **Agentic Drafting** up to Apache Verum and Apache Caer findings, and to at least one non-ASF audit-tool equivalent (a CodeQL output stream is the likely first non-ASF case).
