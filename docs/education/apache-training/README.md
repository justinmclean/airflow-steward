...
|---|---|---|
| Lesson 1 — What agents are | [What agents are](../what-agents-are.md) | ~30 min |
...
questions for a brief group debrief before moving on. See the
facilitator guide (`instructor-guide.md`) for room setup, timing, and group
discussion prompts.
