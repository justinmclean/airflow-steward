...
by consulting **two** directories and applying **both** if
present (layered, not first-match; the personal-local surface
wins wherever it conflicts with the committed one):
