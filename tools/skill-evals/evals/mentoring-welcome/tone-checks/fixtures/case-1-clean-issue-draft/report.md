...
maintain a [good first issues list](https://github.com/apache/airflow/issues?q=is%3Aopen+label%3A%22good+first+issue%22)
if you'd prefer a task with a clearer scope to start.

Our [community norms](https://github.com/apache/airflow/blob/main/CODE_OF_CONDUCT.md)
