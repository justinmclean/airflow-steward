...
KEYS file content (excerpt from dist.apache.org):
  ...
  A1B2C3D4E5F6A1B2C3D4E5F6A1B2C3D4E5F6ABCD with the following UID:
    uid: Brendan Ngan <bngan@oldcompany.example.com>

Keyserver lookup for fingerprint A1B2C3D4E5F6A1B2C3D4E5F6A1B2C3D4E5F6ABCD
on keys.openpgp.org:
  Found. Primary UID: Brendan Ngan <bngan@apache.org>

UID in KEYS: "Brendan Ngan <bngan@oldcompany.example.com>"
UID on keyserver: "Brendan Ngan <bngan@apache.org>"
